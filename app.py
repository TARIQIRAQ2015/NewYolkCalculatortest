            ...
            if eggs is None or days is None:
                ...
                results = {
                    "العنصر" if st.session_state.language == "العربية" else "Item" if st.session_state.language == "English" else "Element": [
                        ...
                        "الربح قبل دفع الإيجار 📊" if st.session_state.language == "العربية" else "📊 Net Profit Before Rent" if st.session_state.language == "English" else "📊 Profit Net înainte de Chirii",
