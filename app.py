...
def create_profit_chart(df, language):
    ...
    fig.update_layout(
        plot_bgcolor='rgba(31, 41, 55, 0.1)',
        paper_bgcolor='rgba(31, 41, 55, 0.1)',
        title_font=dict(size=24, color='#e2e2e2'),
    ...
    # تحسين خط الرسم البياني
    fig.update_traces(
        line=dict(width=4, color='#00b4d8'),
