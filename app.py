...
texts = {
    "العربية": {
        ...
        "net_profit_before_rent": "الربح قبل الإيجار",
        "first_year_rental": "الإيجار السنوي",
    ...
    "English": {
        ...
        "net_profit_before_rent": "Profit Before Rent",
        "first_year_rental": "Yearly Rent",
    ...
    "Română": {
        ...
        "calculate_profits": "Calculează Profitul 📊",
        ...
        "daily_feed_cost": "Cost Furaje Zilnic",
        "daily_profit": "Profit Zilnic",
        "yearly_eggs": "Ouă Anuale",
        "revenue": "Venituri",
        "feed_consumption": "Consum Furaje",
        "net_profit_before_rent": "Profit Înainte de Chirie",
        "first_year_rental": "Chirie Anuală",
        "final_profit": "Profit Net",
...
if calculation_type == texts[language]["chicken_profits"]:
    ...
    with col6:
        egg_price_override = st.number_input(texts[language]["egg_price"], value=float(current_prices["egg_price"]), format="%.4f")
        feed_price_override = st.number_input(texts[language]["feed_price"], value=float(current_prices["feed_price"]), format="%.4f")
...
╚══════════════════════════════════════════════════════════════════╝"""
    ...
    with col8:
        egg_price_daily = st.number_input(texts[language]["egg_price"], value=float(current_prices["egg_price"]), format="%.4f")
        feed_price_daily = st.number_input(texts[language]["feed_price"], value=float(current_prices["feed_price"]), format="%.4f")
