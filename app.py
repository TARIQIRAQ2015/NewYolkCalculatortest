...
with col1:
    language = st.selectbox(texts[st.session_state.language]["language_select"], ["العربية", "English", "Română"], key="language_selectbox", on_change=lambda: st.session_state.update({"language": language}))
